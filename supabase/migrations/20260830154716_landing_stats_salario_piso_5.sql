-- Corrige o piso de amostra da migration anterior (landing_stats_salario_real):
-- foi aplicada com >= 3 (limiar de detecção de outlier) e devia usar >= 5, o
-- mesmo piso que /ferramentas já usa para exibir salaryP50 (ferramentas.tsx:668).
-- É a peça mais visível do produto — não abre exceção para um piso mais frouxo.
