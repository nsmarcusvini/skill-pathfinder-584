...
/** Tabela derivada da classe estrutural `.table` — canto reto, hairlines. */
...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cn("bg-surface font-medium", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <caption ref={ref} className={cn("caption mt-2 text-left", className)} {...props} />
));
